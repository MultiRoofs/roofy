...
describe("CatalogueView", () => {
  it("lists the three groups and marks unavailable tools with a reason", () => {
    ...
    // Every tool but Height from extent, Roof metrics and Measure solids is
    // still unimplemented, so that is the reason `toolEligibility` returns for
    // the rest of the catalogue. The
