...
describe("computeAverageAzimuth", () => {
  ...
  it("returns the single azimuth for one surface", () => {
    const metrics: RoofMetrics[] = [
      { areaSqM: 50, inclinationDeg: 30, azimuthDeg: 180 },
    ];
  ...
  it("computes circular mean correctly across north wrap", () => {
    ...
    const metrics: RoofMetrics[] = [
      { areaSqM: 50, inclinationDeg: 30, azimuthDeg: 350 },
      { areaSqM: 50, inclinationDeg: 30, azimuthDeg: 10 },
    ];
  ...
  it("returns 0 when all surfaces are flat", () => {
    const metrics: RoofMetrics[] = [
      { areaSqM: 100, inclinationDeg: 0, azimuthDeg: 0 },
      { areaSqM: 50, inclinationDeg: 0.5, azimuthDeg: 0 },
    ];
...
describe("aggregateRoofMetrics", () => {
  ...
  it("computes area-weighted average inclination", () => {
    ...
    const metrics: RoofMetrics[] = [
      { areaSqM: 100, inclinationDeg: 10, azimuthDeg: 180 },
      { areaSqM: 10, inclinationDeg: 50, azimuthDeg: 180 },
    ];
  ...
  it("computes area-weighted average azimuth", () => {
    ...
    const metrics: RoofMetrics[] = [
      { areaSqM: 100, inclinationDeg: 30, azimuthDeg: 180 },
      { areaSqM: 10, inclinationDeg: 30, azimuthDeg: 90 },
    ];
    const agg = aggregateRoofMetrics(metrics);
  ...
  it("sums total area", () => {
    const metrics: RoofMetrics[] = [
      { areaSqM: 30, inclinationDeg: 10, azimuthDeg: 180 },
      { areaSqM: 70, inclinationDeg: 20, azimuthDeg: 90 },
    ];
    const agg = aggregateRoofMetrics(metrics);
